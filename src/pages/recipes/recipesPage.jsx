...
import { calcComponentCost as calcComponentCostUtil, buildGenericOptions } from '../../utils/recipeCost';
...
const calcComponentCost = calcComponentCostUtil;
...
const RecipesPage = () => {
  ...
  const genericOptions = useMemo(() => buildGenericOptions(inventory).map(o => ({ ...o, label: o.value })), [inventory]);
